	...
	public sealed partial class MainPage : RemedyPic.Common.LayoutAwarePage
	{
		...
		private void OnColorApplyClick(object sender, RoutedEventArgs e)
		{
			...
			switch (appliedColors)
			{
				...
				case "redcolor":
					prepareImage(bitmapStream, bitmapImage, imageOriginal);
					imageOriginal.ColorChange(RedColorSlider.Value, FilterFunctions.ColorType.Red);
					setStream(bitmapStream, bitmapImage);
					break;
				case "greencolor":
					prepareImage(bitmapStream, bitmapImage, imageOriginal);
					imageOriginal.ColorChange(GreenColorSlider.Value, FilterFunctions.ColorType.Green);
					setStream(bitmapStream, bitmapImage);
					break;
				case "bluecolor":
					prepareImage(bitmapStream, bitmapImage, imageOriginal);
					imageOriginal.ColorChange(BlueColorSlider.Value, FilterFunctions.ColorType.Blue);
					setStream(bitmapStream, bitmapImage);
					break;
				case "redcontrast":
					prepareImage(bitmapStream, bitmapImage, imageOriginal);
					imageOriginal.Contrast(RedContrastSlider.Value, FilterFunctions.ColorType.Red);
					setStream(bitmapStream, bitmapImage);
					break;
				case "greencontrast":
					prepareImage(bitmapStream, bitmapImage, imageOriginal);
					imageOriginal.Contrast(GreenContrastSlider.Value, FilterFunctions.ColorType.Green);
					setStream(bitmapStream, bitmapImage);
					break;
				case "bluecontrast":
					prepareImage(bitmapStream, bitmapImage, imageOriginal);
					imageOriginal.Contrast(BlueContrastSlider.Value, FilterFunctions.ColorType.Blue);
					setStream(bitmapStream, bitmapImage);
					break;
				default:
					break;
